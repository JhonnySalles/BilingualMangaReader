...
class GridViewHolder(itemView: View, private val listener: BookCardListener) :
    ...
    fun bind(book: Book) {
        val bookImage: ImageView = itemView.findViewById(R.id.book_grid_image_cover)
        val bookTitle: TextView = itemView.findViewById(R.id.book_grid_text_title)
        val bookSubTitle: TextView = itemView.findViewById(R.id.book_grid_sub_title)
        val bookProgress: ProgressBar = itemView.findViewById(R.id.book_grid_book_progress)
        val cardView: LinearLayout = itemView.findViewById(R.id.book_grid_card)
